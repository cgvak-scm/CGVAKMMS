...
:setvar DefaultDataPath "C:\Users\CGVAK-LT223\AppData\Local\Microsoft\VisualStudio\SSDT\MMSDB"
:setvar DefaultLogPath "C:\Users\CGVAK-LT223\AppData\Local\Microsoft\VisualStudio\SSDT\MMSDB"
...
GO
PRINT N'Creating Table [dbo].[Department_Master]...';
...
GO
PRINT N'Creating Table [dbo].[Designation_Master]...';
...
GO
PRINT N'Creating Table [dbo].[Employee_Department]...';
...
GO
PRINT N'Creating Table [dbo].[Employee_Master]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Attachment]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Blood_Details]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Employee_Attachment]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Employee_Location]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Employee_Master]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Login_Master]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Category]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Details]...';
...
CREATE TABLE [dbo].[MMS_Meeting_Details] (
    ...
    [Percentage_Completed] NUMERIC (5, 2) NULL,
    [Category]             INT            NULL,
    [is_read_notification] VARCHAR (30)   NULL,
    [seen]                 BIT            NULL,
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Master]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Participant]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Status]...';
...
CREATE TABLE [dbo].[MMS_Meeting_Status] (
    ...
    [Meeting_Id]                       INT           NULL,
    [Meeting_Status_Hours]             NVARCHAR (50) NULL,
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Status_Update]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Template]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Meeting_Template_Users]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Notifications]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Priority]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Review_Frequency]...';
...
GO
PRINT N'Creating Table [dbo].[MMS_Track_ReviewTasks]...';
...
GO
PRINT N'Creating Table [dbo].[Task_Status]...';
...
GO
PRINT N'Creating Default Constraint [dbo].[DF__MMS_Meeti__Perce__1DE57479]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Details]
    ADD CONSTRAINT [DF__MMS_Meeti__Perce__1DE57479] DEFAULT ((0)) FOR [Percentage_Completed];


GO
PRINT N'Creating Default Constraint [dbo].[read_ky]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Details]
    ADD CONSTRAINT [read_ky] DEFAULT ((0)) FOR [is_read_notification];


GO
PRINT N'Creating Default Constraint [dbo].[seenCK]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Details]
    ADD CONSTRAINT [seenCK] DEFAULT ((1)) FOR [seen];


GO
PRINT N'Creating Default Constraint [dbo].[DF__MMS_Meeti__IsDel__20C1E124]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Details]
    ADD CONSTRAINT [DF__MMS_Meeti__IsDel__20C1E124] DEFAULT ((0)) FOR [IsDeleted];


GO
PRINT N'Creating Default Constraint [dbo].[DF__MMS_Meeting__baz__21B6055D]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Details]
    ADD CONSTRAINT [DF__MMS_Meeting__baz__21B6055D] DEFAULT ((0)) FOR [baz];


GO
PRINT N'Creating Default Constraint [dbo].[DF__MMS_Meeti__istem__25869641]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Master]
    ADD CONSTRAINT [DF__MMS_Meeti__istem__25869641] DEFAULT ((0)) FOR [istemplate];


GO
PRINT N'Creating Default Constraint [dbo].[DF_MMS_Meeting_Status_Meeting_Status_Hours]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Status]
    ADD CONSTRAINT [DF_MMS_Meeting_Status_Meeting_Status_Hours] DEFAULT (N'HH:MM') FOR [Meeting_Status_Hours];


GO
PRINT N'Creating Default Constraint [dbo].[def_read]...';


GO
ALTER TABLE [dbo].[MMS_Notifications]
    ADD CONSTRAINT [def_read] DEFAULT ((0)) FOR [is_read];


GO
PRINT N'Creating Foreign Key [dbo].[fkey_meeting_id]...';


GO
ALTER TABLE [dbo].[MMS_Attachment] WITH NOCHECK
    ADD CONSTRAINT [fkey_meeting_id] FOREIGN KEY ([Meeting_Id]) REFERENCES [dbo].[MMS_Meeting_Master] ([Meeting_Id]);


GO
PRINT N'Creating Foreign Key [dbo].[fkey_empid]...';


GO
ALTER TABLE [dbo].[MMS_Login_Master] WITH NOCHECK
    ADD CONSTRAINT [fkey_empid] FOREIGN KEY ([Employee_Id]) REFERENCES [dbo].[MMS_Employee_Master] ([Employee_Id]);


GO
PRINT N'Creating Foreign Key [dbo].[Fkey_id]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Details] WITH NOCHECK
    ADD CONSTRAINT [Fkey_id] FOREIGN KEY ([Meeting_Id]) REFERENCES [dbo].[MMS_Meeting_Master] ([Meeting_Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK__MMS_Meeti__Meeti__0B91BA14]...';


GO
ALTER TABLE [dbo].[MMS_Meeting_Participant] WITH NOCHECK
    ADD CONSTRAINT [FK__MMS_Meeti__Meeti__0B91BA14] FOREIGN KEY ([Meeting_Id]) REFERENCES [dbo].[MMS_Meeting_Master] ([Meeting_Id]);


GO
PRINT N'Creating Foreign Key [dbo].[fk_meet_id]...';


GO
ALTER TABLE [dbo].[MMS_Notifications] WITH NOCHECK
    ADD CONSTRAINT [fk_meet_id] FOREIGN KEY ([meeting_id]) REFERENCES [dbo].[MMS_Meeting_Master] ([Meeting_Id]);


GO
PRINT N'Creating View [dbo].[MailDetail_TaskNotCompleted]...';
...
GO
PRINT N'Creating View [dbo].[vw_get_Designations]...';
...
GO
PRINT N'Creating View [dbo].[vw_get_EmployeeDepartment]...';
...
GO
PRINT N'Creating View [dbo].[vw_get_EmployeeDepartments]...';
...
GO
PRINT N'Creating View [dbo].[vw_get_Employees]...';
...
FROM         dbo.Employee_Master
GO
PRINT N'Creating View [dbo].[vw_get_EmployeesTech]...';
...
GO
PRINT N'Creating Procedure [dbo].[getmeetingdetailsNew]...';
...
GO
PRINT N'Creating Procedure [dbo].[getmeetingsummarydetailsNew]...';
...
--select * from employeemaster where EmployeeDisplayName like '%samyu%'
GO
PRINT N'Creating Procedure [dbo].[GetTaskComments]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Proc_Get_meeting_status]...';
...
GO
PRINT N'Creating Procedure [dbo].[Proc_Get_Review_Tasks]...';
...
MMD.Status,
  ...
  ,  MMM.Meeting_Date
GO
PRINT N'Creating Procedure [dbo].[Proc_MyTask]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_add_Employee_Department]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_add_mms_notifications]...';
...
GO
PRINT N'Creating Procedure [dbo].[sp_Check_Login_Details]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_get_EmailId]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_Get_Employee_By_Email]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_get_Employee_Department]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_get_EmployeeMaster_forJSON]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_get_meeting_details]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_get_meeting_details_Advanced]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_get_meeting_id]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_get_meeting_master_viewByDept]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_get_MeetingSearch_Summary_01102019]...';
...
GO
PRINT N'Creating Procedure [dbo].[sp_get_MeetingSearch_Summary_13072018]...';
...
--select * from Employee_Master where EmployeeICode=10010
GO
PRINT N'Creating Procedure [dbo].[sp_get_mms_notification]...';
...
GO
PRINT N'Creating Procedure [dbo].[sp_get_notification_summary]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_get_Participants]...';
...
BEGIN    
 ...
 END
GO
PRINT N'Creating Procedure [dbo].[sp_getCompletionEffectivenessReport]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_getCompReport_2442018]...';
...
GO
PRINT N'Creating Procedure [dbo].[sp_getname_EmployeeMaster]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_insert_Attachment]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_EmployeeAttachments]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_EmployeeMaster]...';
...
--END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_Meeting_Participant]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_Meeting_Status]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_insert_meeting_status_24062014_1]...';
...
CREATE PROCEDURE [dbo].[sp_insert_meeting_status_24062014_1]  
 ...
 AS  
	BEGIN
 	...
 	END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_MeetingDetails]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_MeetingDetails1]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_MeetingMaster]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_insert_status_update]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_notification_count_message]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_select_AttendedMeeting_Name]...';
...
AS  
 ...
 END
GO
PRINT N'Creating Procedure [dbo].[sp_select_Meeting_Id]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_select_Meeting_Name]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_select_Meeting_Participant]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_select_meeting_status]...';
...
--  select * from [dbo].MMS_Meeting_Status.*  
 ...
 END
GO
PRINT N'Creating Procedure [dbo].[sp_select_mms_meeting_details]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[sp_select_mms_meeting_master]...';
...
RETURN
GO
PRINT N'Creating Procedure [dbo].[Sp_Update_Attachment]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Sp_Update_EmployeeAttachments]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Sp_Update_EmployeeMaster]...';
...
End
GO
PRINT N'Creating Procedure [dbo].[sp_update_meeting_Percent]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Sp_Update_MMS_Meeting_Details_Change]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Sp_Update_MMS_Meeting_Details_Change1]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[sp_update_read_notification]...';
...
GO
PRINT N'Creating Extended Property [dbo].[vw_get_EmployeeDepartment].[MS_DiagramPane1]...';
...
GO
PRINT N'Creating Extended Property [dbo].[vw_get_EmployeeDepartment].[MS_DiagramPaneCount]...';
...
GO
ALTER TABLE [dbo].[MMS_Attachment] WITH CHECK CHECK CONSTRAINT [fkey_meeting_id];

ALTER TABLE [dbo].[MMS_Login_Master] WITH CHECK CHECK CONSTRAINT [fkey_empid];

ALTER TABLE [dbo].[MMS_Meeting_Details] WITH CHECK CHECK CONSTRAINT [Fkey_id];

ALTER TABLE [dbo].[MMS_Meeting_Participant] WITH CHECK CHECK CONSTRAINT [FK__MMS_Meeti__Meeti__0B91BA14];

ALTER TABLE [dbo].[MMS_Notifications] WITH CHECK CHECK CONSTRAINT [fk_meet_id];
